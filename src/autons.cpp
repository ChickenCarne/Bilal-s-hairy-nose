...
*/
void left2(){
  chassis.pid_drive_set(-35.75_in, 63, true);
  pros::delay(1600);
  clampbru.set(true);
  pros::delay(310);
  setIntake(127);
  ...
  pros::delay(2000);
  setIntake(90);
  chassis.pid_drive_set(26_in, 100, true);
...
void rightRedRush(){
  chassis.pid_drive_set(-30_in, 66, true);
  chassis.pid_wait();
  chassis.pid_turn_set(-25_deg, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_drive_set(-15_in, 66, true);
  chassis.pid_wait();
  clampbru.set(true);
  chassis.pid_drive_set(6_in, 66, true);
  chassis.pid_wait();
  clampbru.set(false);
  pros::delay(200);
  chassis.pid_drive_set(-1_in, 66, true);
  chassis.pid_wait();
  clampbru.set(true);
  setIntake(127);
  pros::delay(250);
...
void leftBlue(){
  chassis.pid_drive_set(-14_in, 66, true);
  chassis.pid_wait();
  chassis.pid_turn_set(-90_deg, TURN_SPEED);
  chassis.pid_wait();
  secRing.set(true);
  chassis.pid_drive_set(23.5_in, 66, true);
  chassis.pid_wait(); 
  secRing.set(false);
  setIntake(127);
  pros::delay(500);
  ...
  pros::delay(600);
  setIntake(127);
  chassis.pid_drive_set(-27.5_in, 66, true);
  chassis.pid_wait();
  pros::delay(350);
  setIntake(0);
  chassis.pid_turn_set(360_deg, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_drive_set(-22_in, 66, true);
  chassis.pid_wait();
  clampbru.set(true);
  setIntake(127);
  pros::delay(350);
...
void skills(){   
  ...
  pros::delay(2000);
  nextState();
  chassis.pid_drive_set(-5.4_in, 66, true);
  chassis.pid_wait();
  chassis.pid_turn_set(-77_deg, 100);
  chassis.pid_wait();
  chassis.pid_wait();
  chassis.pid_drive_set(-23_in, 63, true);
  chassis.pid_wait();
  pros::delay(1700);  
  clampbru.set(true); 
  pros::delay(750); 
  ...
  pros::delay(500);
  setIntake(0);
  chassis.pid_drive_set(-4.4_in, 70, true);
  chassis.pid_wait();
  pros::delay(1550);
  setIntake(0);
  pros::delay(100);
  ...
  setIntake(-0);
  pros::delay(200);
  chassis.pid_drive_set(6.5_in,90, true);
  chassis.pid_wait();
...
void test(){
  ...
  chassis.pid_wait();
  chassis.pid_turn_set(360_deg, 100);  
}
